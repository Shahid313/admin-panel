...
const AppRoutes = [
  ...
  {
    path: '/apps/crud/addProduct',
    component: lazy(() => import('../../views/apps/crud/addProduct/addProduct')),
    meta: {
      navLink: '/apps/crud/addProduct'
    }
  },
  {
    path: '/edit/:id',
    component: lazy(() => import('../../views/apps/crud/addProduct/EditProduct'))
  }
]
